...
layout: home
title: "Home"
description: "Turn your living room TV into a dedicated, hands-free video calling portal using Raspberry Pi, HDMI-CEC automation, and Google Meet."
---
...
<section class="hero-section">
  <div class="hero-content">
    ...
    <p class="hero-desc">
      A 50″+ TV at home and still squinting at small phones or laptops? CallOnTV harnesses the power of <strong>Raspberry Pi</strong>, <strong>HDMI-CEC automation</strong>, and <strong>Google Meet</strong> to bring life-sized, crystal-clear video calls to your living room.
    </p>
...
<section class="flow-banner">
  ...
  <div class="flow-steps">
    ...
    <div class="flow-step-box">
      ...
      <div class="flow-step-label">Raspberry Pi 4/5</div>
    ...
    <div class="flow-step-box">
      ...
      <div class="flow-step-label">Wide-Angle Webcam</div>
      <small style="color: var(--text-muted); font-size: 0.75rem;">Logitech Brio 90° FOV</small>
    </div>
    <div class="flow-arrow"><i class="fas fa-arrow-right"></i></div>
    <div class="flow-step-box">
  ...
  <div class="row g-4">
    <div class="col-md-4">
      <div class="step-card h-100">
        ...
        <p style="color: var(--text-muted); font-size: 0.95rem;">
          Grab a Raspberry Pi 4 (4GB+) or Pi 5, a wide-angle webcam (Logitech Brio recommended), a microHDMI cable, and check your TV for HDMI-CEC support.
        </p>
    ...
    <div class="col-md-4">
      <div class="step-card h-100">
        ...
        <p style="color: var(--text-muted); font-size: 0.95rem;">
          Flash Raspberry Pi OS 64-bit, configure display and HDMI-CEC utilities (`cec-utils`), and set up the `/usr/local/bin/tv` automation daemon.
        </p>
